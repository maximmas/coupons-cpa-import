...
// require_once ( plugin_dir_path( __FILE__ ) . '/m-panel/m-panel.php' );
...
function cci_set_config_data(){
    ...
    // фильтр действующие/истекшие
    CCI_Editor::add_filters();

    // метаполя на панели quick edit
...
// полная очистка таблицы очистки кэша в начале месяца
...
// интервал для крона очистки кэша
